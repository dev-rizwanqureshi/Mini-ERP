...
* @see app/Http/Controllers/ProductController.php:66
...
* @route '/products/{product}/stock-adjustments'
*/
...
adjustStock.definition = {
    methods: ["post"],
    url: '/products/{product}/stock-adjustments',
} satisfies RouteDefinition<["post"]>
...
const ProductController = { index, create, store, show, edit, update, destroy, adjustStock }
